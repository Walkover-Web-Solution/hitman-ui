...
class CollectionVersions extends Component {
  ...
  async handleDelete(collectionVersion) {
    ...
    const collectionVersions = this.state.collectionVersions.filter(
  ...
  handleUpdate(collectionVersion) {
    ...
    this.props.history.push(
      `/collections/${this.state.collectionId}/versions/${collectionVersion.number}/edit`
    );
  }
