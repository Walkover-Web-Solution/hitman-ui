	...
	render() {
		return (
			<div>
				{this.props.versions &&
					this.props.versions
						.filter((version) => version.collectionId === this.props.collection_id)
									...
									<Card.Header>
										...
										>
											...
											<Dropdown.Item
												eventKey="3"
												onClick={() =>
													this.handleAddGroup(collectionVersion.id, this.props.collectionId)}
											>
												Add Group
											</Dropdown.Item>
											<Dropdown.Item
												eventKey="3"
												onClick={() =>
													this.handleAddPage(collectionVersion.id, this.props.collectionId)}
											>
												Add Page
											</Dropdown.Item>
										</DropdownButton>
