...
class DeleteSidebarEntityModal extends Component {
  ...
  handleSubmit (e) {
    ...
    getModalData = () => {
      ...
      switch (type) {
        case 'collections':
          return collections[id].importedFromMarketPlace
            ? confirmationModalEnum.REMOVE_COLLECTION
            : confirmationModalEnum.DELETE_COLLECTION
        case 'versions': return confirmationModalEnum.DELETE_VERSION
        case 'groups': return confirmationModalEnum.DELETE_GROUP
        case 'pages': return confirmationModalEnum.DELETE_PAGE
        case 'endpoints': return confirmationModalEnum.DELETE_ENDPOINT
