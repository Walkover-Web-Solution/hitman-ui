...
function GenericModal({ email, name, validateEmail, validateName, keyboard, loading, centered, showInputGroup, modalBody, handleKeyPress, inputRef, setEmail, handleSendInvite, handleCloseModal, showModal, title, showInput, handleAddOrg, setName, orgName }) {
          ...
          {showInputGroup && (
            <>
              <InputGroup className='mb-2'>
                <Form.Control ref={inputRef} placeholder='Enter User Name' type='name' aria-label="Recipient's name" aria-describedby='basic-addon2' value={name} onChange={(e) => setName(e.target.value)} onKeyDown={handleKeyPress} />
              </InputGroup>
              <InputGroup>
                <Form.Control placeholder='Enter User Email' type='email' aria-label="Recipient's email" aria-describedby='basic-addon2' value={email} onChange={(e) => setEmail(e.target.value)} onKeyDown={handleKeyPress} isInvalid={email && !validateEmail(email)} />
              </InputGroup>
