      ...
      if (endpoint.state === publishDocsEnum.DRAFT_STATE && endpoint.isPublished) {
        ...
        result = {
          ...
          body: {
            ...
            value:
              currentChanges.body.type === authorizationTypesEnums['multipart/form-data'] || currentChanges.body.type === authorizationTypesEnums['application/x-www-form-urlencoded']
