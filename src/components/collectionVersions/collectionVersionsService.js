...
function setDefaultVersion(props, onHide, parentPageId, title) {
  return <CollectionDefaultVersionForm {...props} show onHide={onHide} parentPage_id={parentPageId} title={title} />
}
...
export default { showDeleteVersionModal, showVersionForm, setDefaultVersion }
