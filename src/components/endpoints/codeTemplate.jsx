          ...
          <Col className='editor-body-wrapper' xs={12}>
            <div className='ace-editor-wrapper'>
              <div id='code-window-body' className={!isOnPublishedPage() ? "copy-button-light" : "copy-button-dark"}>
                <CopyToClipboard text={this.state.codeSnippet ? this.state.codeSnippet : this.codeSnippet} onCopy={() => this.setState({ copied: true }, () => setTimeout(() => this.setState({ copied: false }), 1000))} className='copy-to-clipboard mt-1'>
                  <button>
                    {this.state.copied ? (
                      <IconButton>
                        {" "}
