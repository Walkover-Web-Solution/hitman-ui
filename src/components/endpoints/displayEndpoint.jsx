                                ...
                                <>
                                  <li className="nav-item">
                                    <a
                                      ...
                                      aria-selected={this.state.activeTab === 'params'}
                                      onClick={() => this.setState({ activeTab: 'params' })}
                                    >
                                      Params
                                    </a>
                                  </li>
                                ...
                                <>
                                  <li className="nav-item">
                                    <a
                                      ...
                                      aria-selected={this.state.activeTab === 'query'}
                                      onClick={() => this.setState({ activeTab: 'query' })}
                                    >
                                      Query
                                    </a>
                                  </li>
