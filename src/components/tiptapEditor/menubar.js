...
export default function MenuBar({ editor }) {
  ...
  return (
    <div className='menuBar custom-editor'>
      ...
      <button type='button' onClick={() => editor.chain().focus().toggleUnderline().run()} className={editor.isActive("underline") ? "is_active" : ""}>
        <FaUnderline />
      </button>

      <button type='button' onClick={() => editor.chain().focus().toggleHighlight().run()} className={editor.isActive("highlight") ? "is_active" : ""}>
        <FaHighlighter />
      </button>
