...
class Pages extends Component {
  ...
  handleDisplay(page, collectionId, previewMode) {
    if (isDashboardRoute(this.props, true)) {
      ...
      } else if (this.props.tabs.tabs[page.id].previewMode === true && previewMode === false) {
  ...
  displayDuplicateOpt(pageId) {
    return (
      <div className='dropdown-item' onClick={() => this.handleDuplicate(this.props.pages[pageId])}>
        <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
  ...
  displayMakePublicOpt(pageId) {
    return (
      <div className='dropdown-item' id='make_public_btn' onClick={() => this.handlePublicPageState(this.props.pages[pageId])}>
        <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
  ...
  displayCancelRequestOpt(pageId) {
    return (
      <div className='dropdown-item' onClick={() => this.handleCancelRequest(this.props.pages[pageId])}>
        <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
  ...
  displayOtherOpt(pageId) {
    return (
      <>
        {this.isStateDraft(pageId) || this.isStateReject(pageId) ? this.displayMakePublicOpt(pageId) : null}
        {this.isStateApproved(pageId) ? this.displayApproveOpt() : null}

        {this.isStatePending(pageId) ? this.displayCancelRequestOpt(pageId) : null}
      </>
    )
  }
    ...
    return (
      <div className='sidebar-item-action'>
        ...
        <div className='dropdown-menu dropdown-menu-right'>
          ...
          {this.props.pages[pageId]?.isPublished ? this.displayApproveOpt() : this.displayOtherOpt(pageId)}
        </div>
      </div>
    )
  }
  ...
  render() {
    ...
    return <>{isDashboardRoute(this.props, true) ? this.displayUserPages(pageId) : this.displayPublicPages(pageId)}</>
  }
}
