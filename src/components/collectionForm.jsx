...
class CollectionForm extends Form {
	...
	async componentDidMount() {
		...
		if (this.props.location.editedcollection) {
			const { name, website, description, keyword } = this.props.location.editedcollection;
			...
			const { data: editedCollection } = await collectionsService.getCollection(collectionId);
