  ...
  render() {
    return (
      <div onKeyPress={(e) => onEnter(e, this.doSubmit.bind(this))}>
        <Modal show={this.props.show} onHide={this.props.onHide} size='lg' animation={false} aria-labelledby='contained-modal-title-vcenter' centered className='custom-environment'>
            ...
            <div className='custom-environment-modal-container'>
              ...
              <Modal.Body className='p-3'>
                <div className='form-group mb-0'>
                  ...
                  <input name='name' value={this.state.environment.name} onChange={this.handleChangeEnv} type='text' id='custom-environment-input' className='form-control' placeholder='Environment Name' />
                  <div>
                        ...
                        variable !== "deleted" ? (
                          <tr key={index}>
                            <td className='custom-td'>
                              <input name={index + ".name"} value={variable} onChange={this.handleChange} type='text' style={{ border: "none" }} className='form-control' />
                            </td>
                            <td className='custom-td'>
                              {" "}
                              <input name={index + ".initialValue"} value={this.state.environment.variables[this.state.originalVariableNames[index]].initialValue} onChange={this.handleChange} type='text' className='form-control' style={{ border: "none" }} />
                            </td>
                            <td className='custom-td'>
                              {" "}
                              <input name={index + ".currentValue"} value={this.state.environment.variables[this.state.originalVariableNames[index]].currentValue} onChange={this.handleChange} type='text' style={{ border: "none" }} className='form-control' />
                            </td>
