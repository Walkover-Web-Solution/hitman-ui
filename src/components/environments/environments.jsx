      ...
      if (isDashboardRoute(this.props)) {
        return (
          <div className='environment-container d-flex align-items-center transition'>
            {(this.state.environmentFormName === 'Add new Environment' || this.state.environmentFormName === 'Edit Environment') &&
            ...
            {this.state.environmentFormName === 'Environment modal' && (
              <EnvironmentModal
                ...
                close_delete_environment_modal={this.closeDeleteEnvironmentModal.bind(this)}
