        ...
        <div className='user-notification user-info '>
          <div className='user-avatar '>
            ...
            <svg width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
              ...
              <g mask='url(#mask0)'>
                <path d='M18.9102 19.0303L11.0096 19.0305L3.10892 19.0305C3.1089 12.377 6.97581 12.377 11.0096 12.377C15.0433 12.377 18.9102 12.377 18.9102 19.0303Z' fill='#C7C4C2' />
              </g>
                        ...
                        <>
                          <span>
                            ...
                            <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                              <path d='M13.5 6C13.5 4.80653 13.0259 3.66193 12.182 2.81802C11.3381 1.97411 10.1935 1.5 9 1.5C7.80653 1.5 6.66193 1.97411 5.81802 2.81802C4.97411 3.66193 4.5 4.80653 4.5 6C4.5 11.25 2.25 12.75 2.25 12.75H15.75C15.75 12.75 13.5 11.25 13.5 6Z' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                              <path d='M10.2975 15.75C10.1657 15.9773 9.9764 16.166 9.74868 16.2971C9.52097 16.4283 9.2628 16.4973 9.00001 16.4973C8.73723 16.4973 8.47906 16.4283 8.25134 16.2971C8.02363 16.166 7.83437 15.9773 7.70251 15.75' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                            </svg>
                          </span>
                    ...
                    <div className='dropdown-item' style={{ cursor: 'pointer' }} onClick={() => this.navigateToViaSocket()}>
                      <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <g clip-path='url(#clip0)'>
                          <path d='M6.75 15.5L3.75 15.5C3.35218 15.5 2.97064 15.342 2.68934 15.0607C2.40804 14.7794 2.25 14.3978 2.25 14L2.25 3.5C2.25 3.10217 2.40804 2.72064 2.68934 2.43934C2.97065 2.15804 3.35218 2 3.75 2L6.75 2' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
