                ...
                <div className='dropdown-menu dropdown-menu-right'>
                    ...
                    >
                      ...
                      >
                        <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                          ...
                          <path d='M2 15.25C1.58579 15.25 1.25 15.5858 1.25 16C1.25 16.4142 1.58579 16.75 2 16.75V15.25ZM16 16.75C16.4142 16.75 16.75 16.4142 16.75 16C16.75 15.5858 16.4142 15.25 16 15.25V16.75ZM2 16.75H16V15.25H2V16.75Z' fill='#E98A36' />
                          <path d='M2 10.25C1.58579 10.25 1.25 10.5858 1.25 11C1.25 11.4142 1.58579 11.75 2 11.75V10.25ZM16 11.75C16.4142 11.75 16.75 11.4142 16.75 11C16.75 10.5858 16.4142 10.25 16 10.25V11.75ZM2 11.75H16V10.25H2V11.75Z' fill='#E98A36' />
                          <path d='M6.5 5.5L9.25 8L12 5.5' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                      ...
                      {this.props.collections[collectionId].isPublic && (
                        ...
                        >
                          <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                            <path d='M10.5 1.5H4.5C4.10218 1.5 3.72064 1.65804 3.43934 1.93934C3.15804 2.22064 3 2.60218 3 3V15C3 15.3978 3.15804 15.7794 3.43934 16.0607C3.72064 16.342 4.10218 16.5 4.5 16.5H13.5C13.8978 16.5 14.2794 16.342 14.5607 16.0607C14.842 15.7794 15 15.3978 15 15V6L10.5 1.5Z' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                            ...
                            <path d='M7.5 6.75H6.75H6' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                          </svg> Go to Docs
                        </div>
                      )}
                      {/* {
                  isAdmin()
                    ...
                    : null
                      ...
                      >
                        <svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                          <path d='M1.82189 8.02724L8.10274 1.74639C8.59828 1.25084 9.40172 1.25084 9.89726 1.74639L16.1781 8.02724C16.6737 8.52278 16.6737 9.32622 16.1781 9.82176L9.89726 16.1026C9.40172 16.5982 8.59828 16.5982 8.10274 16.1026L1.82189 9.82176C1.32634 9.32622 1.32634 8.52278 1.82189 8.02724Z' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
                          <line x1='0.75' y1='-0.75' x2='7.32538' y2='-0.75' transform='matrix(-0.707107 0.707107 0.707107 0.707107 12.2629 3.70117)' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' />
                          <line x1='11.8551' y1='8.97961' x2='7.20558' y2='13.6291' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' />
                          <line x1='6.79772' y1='8.5957' x2='9.00001' y2='10.798' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' />
                          <line x1='9.24493' y1='6.14844' x2='11.8182' y2='8.7217' stroke='#E98A36' strokeWidth='1.5' strokeLinecap='round' />
                        </svg>
