...
class CollectionsComponent extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (pageId && prevPageId !== pageId)
      this.setCollectionForEntity(pageId, "page");
    ...
    return (
      <React.Fragment key={collectionId}>
        <div
          ...
          id="parent-accordion"
          className={
            expanded ? "sidebar-accordion expanded" : "sidebar-accordion"
          }
          ref={(newRef) => {
              ...
              <div className="d-flex justify-content-between">
                <div className="w-100 d-flex">
                  ...
                  {collectionState === "singleCollection" ? (
                    ...
                    <span className="truncate collect-length">
                      {" "}
                      {this.props.collections[collectionId].name}{" "}
                    </span>
                  )}
            ...
            <div className="d-flex align-items-center">
              <div className="sidebar-item-action d-flex align-items-center">
                <div
                  ...
                  onClick={() =>
                    this.openAddCollectionPageForm(
                      this.props.collections[collectionId]
                    )
                  }
                >
              ...
              <Card.Body>
                    ...
                    /> */}
                {
                  ...
                  <CombinedCollections
                    ...
                    selectedCollection
                    rootParentId={
                      this.props.sideBarCollections[collectionId].rootParentId
                    }
                  />
                }
              </Card.Body>
  ...
  showDeleteCollectionModal() {
    const title = this.state.showRemoveModal
      ? "Remove Collection"
      : "Delete Collection";
  ...
  comparison(a, b) {
    if (
      this.props.collections[a].name.toLowerCase() <
      this.props.collections[b].name.toLowerCase()
    ) {
      return -1;
    } else if (
      this.props.collections[a].name.toLowerCase() >
