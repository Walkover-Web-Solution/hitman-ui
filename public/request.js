...
const { authorizationTypesEnums } = require('../src/components/common/authorizationTypesEnums')
...
async function makeHttpRequestThroughAxios(
  ...
  if (headers['content-type'] === authorizationTypesEnums['multipart/form-data']) {
  ...
  } else if (headers['content-type'] === authorizationTypesEnums['application/x-www-form-urlencoded']) {
